			...
			steps: [
				{
					...
					intro: 'This tool helps you format debate evidence with proper citations and multi-level text highlighting. Let\'s take a quick tour!'
				},
				{
					element: document.querySelector('[data-intro="url-input"]') as HTMLElement,
					title: 'Start with a URL',
					intro: 'Paste the article URL here. When you click away, we\'ll automatically extract metadata like title, author, publisher, and date.'
				},
				{
					element: document.querySelector('[data-intro="ai-settings"]') as HTMLElement,
					title: 'AI-Powered Extraction',
					intro: 'If automatic extraction can\'t find the author, you can configure AI extraction with your own API key (OpenAI, Anthropic, or Google).'
				},
				{
					element: document.querySelector('[data-intro="citation-fields"]') as HTMLElement,
					title: 'Citation Information',
					intro: 'Review and edit the extracted citation information. All fields are editable, and you can add qualifications and your debate code.'
				},
				{
				...
				},
				{
					...
					intro: 'Select text in the evidence area, then click a highlight level to apply formatting. You can apply multiple levels and they\'ll merge intelligently.'
				},
				{
					element: document.querySelector('[data-intro="highlight-config"]') as HTMLElement,
					title: 'Customize Highlights',
					intro: 'Click here to customize highlight levels - change colors, make text bold/underlined, adjust font sizes, or add new levels.'
				},
				{
					element: document.querySelector('[data-intro="preview"]') as HTMLElement,
					title: 'Preview & Copy',
					intro: 'See how your formatted card will look. Click "Copy to Clipboard" to copy rich text that pastes perfectly into Word or Google Docs!'
				},
				{
